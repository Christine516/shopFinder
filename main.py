...
class MainPage(BaseHandler):
            ...
            if self.user.logged_in:
                ...
                if len(popular_posts) > 5:
                    ...
                    params = {
                        ...
                        "user_image_url": self.user.user_photo,
    ...
    def post(self):
        ...
        self.render_template("home.html",template_vars)
...
app = webapp2.WSGIApplication([
    ...
    webapp2.Route('/SearchImage', handler=SearchImagePage, name='SearchImage'),
