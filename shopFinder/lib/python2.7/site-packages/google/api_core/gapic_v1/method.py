...
class _GapicCallable(object):
    ...
    Args:
        ...
        timeout (google.google-api-core.timeout.Timeout): The default timeout
...
def wrap_method(
    ...
    For example::
        ...
        import google.google-api-core.gapic_v1.method
        from google.google-api-core import retry
        from google.google-api-core import timeout
        ...
        wrapped_get_topic = google.google-api-core.gapic_v1.method.wrap_method(
    ...
    * The final ``get_topic_with_timeout_and_retry`` is called passing through
    ...
    Args:
        ...
        default_retry (Optional[google.google-api-core.Retry]): The default retry
            strategy. If ``None``, the method will not retry by default.
        default_timeout (Optional[google.google-api-core.Timeout]): The default
            timeout strategy. Can also be specified as an int or float. If
            ``None``, the method will not have timeout specified by default.
        client_info
            (Optional[google.google-api-core.gapic_v1.client_info.ClientInfo]):
