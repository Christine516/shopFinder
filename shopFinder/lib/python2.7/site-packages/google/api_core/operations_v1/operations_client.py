...
class OperationsClient(object):
    ...
    def get_operation(
        ...
        Example:
            >>> from google.google-api-core import operations_v1
        ...
        Raises:
            google.google-api-core.exceptions.GoogleAPICallError: If an error occurred
    ...
    def list_operations(
        ...
        Raises:
            google.google-api-core.exceptions.MethodNotImplemented: If the server
