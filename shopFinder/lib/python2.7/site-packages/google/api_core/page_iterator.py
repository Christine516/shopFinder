...
class Page(object):
    ...
    Args:
        ...
        item_to_value (Callable[google.google-api-core.page_iterator.Iterator, Any]):
...
class Iterator(object):
    ...
    def pages(self):
        ...
        returns:
            types.GeneratorType[google.google-api-core.page_iterator.Page]: A
...
class HTTPIterator(Iterator):
    ...
    Args:
        ...
        extra_params (dict): Extra query string parameters for the
            API call.
        page_start (Callable[
            google.google-api-core.page_iterator.Iterator,
            google.google-api-core.page_iterator.Page, dict]): Callable to provide
