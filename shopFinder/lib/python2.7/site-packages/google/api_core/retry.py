...
- :class:`google.google-api-core.exceptions.InternalServerError` - HTTP 500, gRPC
    ``INTERNAL(13)`` and its subclasses.
- :class:`google.google-api-core.exceptions.TooManyRequests` - HTTP 429
- :class:`google.google-api-core.exceptions.ServiceUnavailable` - HTTP 503
- :class:`google.google-api-core.exceptions.ResourceExhausted` - gRPC
...
def retry_target(target, predicate, sleep_generator, deadline, on_error=None):
    ...
    Raises:
        google.google-api-core.RetryError: If the deadline is exceeded while retrying.
